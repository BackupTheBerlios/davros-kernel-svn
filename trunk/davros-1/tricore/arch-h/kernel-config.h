 ...
 *		the default 256 unless you're really short of RAM.
 *	__DAVROS_INTPRIO
...
#define __DAVROS_NVECTORS	256
#define __DAVROS_INTPRIO	255
#define __DAVROS_HZ			100

/*	Interrupt numbers */
#define __DAVROS_INUM_ASC0	3		/* 3 interrupts - 3,4,5 */
#define __DAVROS_INUM_ASC1	6		/* 3 interrupts - 6,7,8 */
#define __DAVROS_INUM_TIMER	10
