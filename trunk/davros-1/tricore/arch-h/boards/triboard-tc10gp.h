/*	triboard-tc10gp-config.h - configuration file for triboard (rider b)
 *
 ...
 *	a Triboard fitted with a tc10gp rider B CPU. The fibbed
...
#if !defined(__triboard_tc10gp_config_h)
#define __triboard_tc10gp_config_h

#define TRICORE_BOARD	TRIBOARD
#define TRICORE_CPU		TC10GP
 ...
 *	The RAM fitted on the board is 4MB SDRAM.
...
#define	INIT_DRMCON0	0x1F000030
#define	INIT_DRMCON1	0x00000023
 ...
 *	4MB		0xa8000051	0x01023000	---			---			0x400000
 *
...
#define	INIT_ADDSEL1	0xa8000051
#define	INIT_BUSCON1	0x01023000
#define	INIT_ADDSEL3	0x00000000
#define	INIT_BUSCON3	0x00000000
