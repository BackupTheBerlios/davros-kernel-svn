/*	arm-icp-enableint.c - __dv_enable_interrupt
 *
...
/*==================================================================================================
 *	__dv_enable_interrupt - enable an interrupt
 *==================================================================================================
*/
__dv_status_t __dv_enable_interrupt
...
)
{
	...
	{
		__dv_arm_pic_pri_irq.enable_set = 1 << intno;
		result = __DV_OK;
	}
	else
	if ( intno < (__DV_NUMINT_PRI + __DV_NUMINT_SEC) )
	{
		__dv_arm_pic_sec.enable_set = 1 << (intno - __DV_NUMINT_PRI);
		result = __DV_OK;
	}
