/*	registerint.c - __dv_register_interrupt
 *
...
/*==================================================================================================
 *	__dv_register_interrupt - register a function and parameter pair as handler for an interrupt
 *==================================================================================================
*/
__dv_status_t __dv_register_interrupt
...
)
{
	...
	if ( intno < __DV_NUMINT )
	{
		...
		if ( isr->func == __dv_unused_interrupt )
		{
			isr->func = func;
			isr->param = param;
			result = __DV_OK;
