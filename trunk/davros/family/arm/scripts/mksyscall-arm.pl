...
#	On the Arm architecture at least 4 parameters can be passed in registers
...
if ( !defined $name )
{
	print STDERR "Usage: mksyscall-arm.pl SYSCALL-NAME\n";
	exit 1;
}
...
print STDOUT "/*  arm-usr-$lcname.s - __dv_usr_$lcname\n";
print STDOUT " *\n";
...
print STDOUT "#include <arm-asm.h>\n";
...
print STDOUT "    swi     __DV_SC_$ucname\n";
print STDOUT "    bx      lr\n";
